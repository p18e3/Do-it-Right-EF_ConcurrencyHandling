...
For the sake of completeness, it should be explained why concurrency conflicts cannot happen during execution of an Insertion or Read operation on the database.
