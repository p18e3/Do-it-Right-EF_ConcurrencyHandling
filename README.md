...
When inserting a new dataset, there cannot arise concurrency conflicts by the reason that it's not possible for other users to access the dataset until it is inserted in the database.
